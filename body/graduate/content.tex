...
Anton Ledergerber\cite{Ledergerber}首先提出使用低成本超宽带设备 dwm1000 进行无设备的行人追踪问题。
...
Bocus等人\cite{Bocus2021}使用Anton采集的数据集，改进了特征提取算法，进一步提升了系统的性能。
...
Li\cite{VATS}等人探讨了使用低成本超宽带设备 dwm1000 进行无设备的行人追踪问题。
